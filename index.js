...
const start = async (tobz = new Client()) => {
        ...
        tobz.onAddedToGroup(async (chat) => {
            if(isWhite(chat.id)) return tobz.sendText(chat.id, 'Halo aku Raisa, Ketik .help Untuk Melihat List Command Ku...')
            if(mtcState === false){
                ...
                if(groups.length > groupLimit){
                    ...
                    if(chat.groupMetadata.participants.length < memberLimit){
                        ...
                        if(!chat.isReadOnly) tobz.sendText(chat.id, 'Halo aku Raisa, Ketik .help Untuk Melihat List Command Ku...')
                    }
                }
            }else{
